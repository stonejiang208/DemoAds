...
def do_build(cocos_root, ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode):
    ...
    if platform == 'win32':
        ...
        ndk_module_path = 'NDK_MODULE_PATH=%s:%s/external:%s/cocos:/Users/jiangtao/workspace/study/android/cocos2d-x-3.0rc2/plugin/publish' % (cocos_root, cocos_root, cocos_root)
